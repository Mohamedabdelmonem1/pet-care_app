...
class _ServicesState extends State<Services> {
          ...
          Column(
            ...
            children: [
              ...
              Container(
                width: double.infinity,
                margin:
                    EdgeInsets.only(top: 10, bottom: 10, right: 13, left: 15),
              ...
              Container(
                ...
                child: MaterialButton(
                  onPressed: () {
                    ...
                    check(
                      category_id: 1,
                      temprature: temprture == "Yes" ? 1 : 0,
                      voming: vomiting == "Yes" ? 1 : 0,
                      lack_of_appetite: appetite == "Yes" ? 1 : 0,
                      urinating: urinating == "Yes" ? 1 : 0,
                    );
                  },
                  child: Text(
                    "Check",
  ...
  check({
    ...
    @required temprature,
    @required voming,
    @required lack_of_appetite,
    @required urinating,
  }) async {
    print('start check');
    await DioHelper.getData(
      url: AppEndPoints.check,
      query: {
        "category_id": 1,
      ...
      showSnackBar(
        context: context,
        text: value.data['result'].toString(),
        clr: Colors.green,
      );
      print('Success check');
    }).catchError((err) {
